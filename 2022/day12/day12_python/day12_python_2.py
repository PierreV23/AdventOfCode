...
def find_shortest_path(starting_point, end_point):
    distances = {}
    y=starting_point[0]
    x=starting_point[1]
    ...
    while queue:
        ...
        for a, b in ((x+1,y), (x-1, y), (x, y+1), (x, y-1)):
            ...
            try:
                ...
                raise Exception()
    if end_point in distances:
        return distances[end_point]
    else: return 10000000

print(find_shortest_path(starting_point, end_point))
a_coords = []
...
print(min(find_shortest_path(coord, end_point) for coord in a_coords))